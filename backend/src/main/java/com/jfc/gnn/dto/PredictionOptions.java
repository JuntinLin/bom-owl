...
public class PredictionOptions {
	private String modelId; // Model ID to use
	...
	public static PredictionOptions defaultOptions() {
		return PredictionOptions.builder().threshold(0.5).maxPredictions(100).modelType(GnnModelConfig.ModelType.GCN)
				.includeAlternatives(true).calculateQuantities(true).build();
	}
}