...
import { ImaFile, BomComponent } from '@/types/tiptop'; // Import types
...
const BomViewer = () => {
  ...
  const handleExportOntology = (format: string) => {
    if (!itemCode) return;
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => handleExportOntology('RDF/XML')}>
            Export as OWL
          </Button>
          <Button variant="outline" onClick={() => handleExportOntology('JSONLD')}>
            Export as JSON-LD
          </Button>
          <Button variant="outline" onClick={() => handleExportOntology('TURTLE')}>
            Export as Turtle
          </Button>
        </div>
      </div>
